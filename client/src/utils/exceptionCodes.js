...
export const EXCEPTION_CODES = {
  ...
  'COQ': 'Change of Quarters (Already assigned)',
  'SD': 'Staff Duty (Already assigned)',
  'CD': 'Command Duty (Already assigned)',
  'DO': 'Duty Officer (Already assigned)',
  'OD': 'Officer of the Day (Already assigned)',
  'NCOOD': 'NCO of the Day (Already assigned)',
  'P': 'Pass',
  'EX': 'Exempt',
  'R': 'Restricted',
  'H': 'Holiday',
